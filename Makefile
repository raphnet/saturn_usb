...
# This Revision: $Id: Makefile,v 1.2 2015-09-25 18:29:35 cvs Exp $
...
OBJECTS = usbdrv/usbdrv.o usbdrv/usbdrvasm.o usbdrv/oddebug.o main.o saturn.o devdesc.o
...
# file targets:
main.bin:	$(COMMON_OBJS) saturn.o devdesc.o 
